...
java -cp "$distDir"/checker.jar:"$distDir"/plume.jar:"$distDir"/checker-framework-inference.jar:$CLASSPATH checkers.inference.InferenceLauncher --checker universe.UniverseTypeInferenceChecker --solver universe.UniverseTypeInferenceConstraintSolver $*
